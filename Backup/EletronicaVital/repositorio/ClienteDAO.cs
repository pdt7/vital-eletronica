       ...
       public void atualizarQuantidade(Cliente produto)
        ...
        public Cliente consultarUltimoCliente()
        {
            try
            {
                ...
                strCmd = strCmd + " WHERE id_cliente=(SELECT MAX(ID_CLIENTE) FROM CLIENTE) ";
                MySqlCommand cmd = new MySqlCommand();
                cmd.Parameters.Clear();
                OpenConnection();
                MySqlDataReader dataReader = Pesquisa(cmd, strCmd);
            ...
            {
                throw new Exception("Não foi possível localizar o último Cliente cadastrado.");
            }
            finally
            {
                CloseConnection();
        ...
        public Cliente consultarClientePorId(int idCliente)
        {
            ...
            {
                throw new Exception("Não foi possível localizar o Cliente pela ID informada." + ex.Message);
            }
            finally
            {
                CloseConnection();
        ...
        public bool existeClienteCadastrado(string telefone)
        {
            try
            {
                MySqlCommand cmd = new MySqlCommand();
                cmd.Parameters.Clear();
                string strCmd = " SELECT c.* FROM cliente c WHERE c.telefone=@telefone";
            ...
            {
                throw new Exception("Não foi possível verificar se o cliente já existe na base.");
            }
            finally
            {
                CloseConnection();
