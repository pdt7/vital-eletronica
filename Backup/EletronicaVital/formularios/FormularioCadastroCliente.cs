...
namespace Vital.formularios
{
    public partial class FormularioCadastroCliente : Form
    {
        ...
        private void botaoCadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                if (existeClienteCadastrado(textTelefone.Text))
                {
                    throw new Exception("Já existe cliente cadastrado com esse telefone.");
                }
                else
                {
                    ...
                    int numero = 0;
                    if (!textNum.Text.Equals(""))
                    {
                        numero = Convert.ToInt32(textNum.Text);
                    }
        ...
        private bool existeClienteCadastrado(string telefone)
        {
            return controladorCliente.existeClienteCadastrado(telefone);
        }
        ...
        private void buttonOS_Click(object sender, EventArgs e)
        {
            ...
            Cliente cliente = controladorCliente.consultarUltimoCliente();
