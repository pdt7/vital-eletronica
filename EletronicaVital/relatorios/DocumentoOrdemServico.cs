...
namespace Vital.relatorios
{
    public partial class DocumentoOrdemServico : Form
    {
        public DocumentoOrdemServico(OrdemServico ordem)
        {
            ...
            string dataEntrega = ordem.DataSaida.Day + "/" + ordem.DataSaida.Month + "/" + ordem.DataSaida.Year;
            p[12] = new Microsoft.Reporting.WinForms.ReportParameter("dataEntrega", dataEntrega);
            p[13] = new Microsoft.Reporting.WinForms.ReportParameter("total", ordem.Valor + ",00");
            p[14] = new Microsoft.Reporting.WinForms.ReportParameter("orcamento", ordem.Orcamento);
